...
Якщо ви бажаєте звести отримані текстові звіти у наочні Markdown-таблиці та автоматично побудувати інтерактивні графіки, скористайтеся допоміжним скриптом:

Переконайтеся, що всі згенеровані файли (result1.txt — result4.txt) знаходяться в одній директорії зі скриптом.

Запустіть аналізатор:
