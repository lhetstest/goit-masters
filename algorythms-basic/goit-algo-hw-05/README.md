...
- substring_search_comparison.py використовується для аналізу алгоритмів, результатом роботи цього скрипта є файл result.txt
- scraping-results.py запускати після того як оброблені файли результатів, в файлі потрібно відредагувати рядок з назвами файлів "result#.txt"
