...
def normalize_phone(phone_number: str) -> str:
    """
    Нормалізує номер телефону для SMS-розсилки.
    Видаляє всі символи, крім цифр та '+', і приводить номер до формату з кодом країни.
    Args:
        phone_number (str): Вхідний номер телефону у довільному форматі.
    Returns:
        str: Нормалізований номер телефону у форматі з префіксом '+'.
    """
