...
def show_help() -> str:
    return (
        ...
        "- add [ім'я] [телефон]: Додати контакт з телефоном, повторно введена з однаковим імʼям додає ще один телефон\n"
...
def main() -> None:
    ...
    При виході з програми зберігає дані у файл
    """
    book = load_data()
    print("Бот-помічник запущено. \nНапишить hello або help для довідки. \nНапишить exit або close для виходу.")
    while True:
